...
function HomeCarousel() {
  return (
    <div id="carouselExampleIndicators" class="carouselPad carousel slide w-100 px-3 px-md-5">
        <div class="carousel-indicators mt-5">
            <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
            <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1" aria-label="Slide 2"></button>
            <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" aria-label="Slide 3"></button>
        </div>
        <div className="carousel-inner h-100 py-4 px-3 px-md-5">
            <div class="carousel-item active card p-3 p-md-5 bgBege rounded-5 h-100 carouselShadow">
                <div class="card-body text-center">
                    ...
                    <img src={ODSimg} className='pt-3 img-fluid' alt="ODS icons"/>
                </div>
            </div>
            <div class="carousel-item card p-3 p-md-5 bgBege rounded-5 carouselShadow h-100">
                <div class="card-body text-center">
                    ...
                    <button className='btnPrimario p-3 rounded-3 mt-5'>Learn more about the tool</button>
                </div>
            </div>
            <div class="carousel-item card p-3 p-md-5 bgBege rounded-5 carouselShadow h-100 ">
                <div class="card-body text-center">
                    ...
                    <p className='text-start pt-3'>Our team - composed of Eduarda Carvalho, Mafalda Duarte, and Mariana Peixe - was challenged to develop a digital version of the analog tool. This platform was designed with a user-centered approach, combining design, technology, and strategy.</p>
                        ...
                        <img src={sobreNos} className='pt-3 img-fluid' alt="our team"/>
